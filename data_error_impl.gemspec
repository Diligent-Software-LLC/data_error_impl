...
require_relative 'lib/data_error_impl/version'
...
a reliable, integrable, and endurable Data library. Make a donation at the
...
appreciated.}
  spec.homepage              =
      'https://docs.diligentsoftware.org/data-1/error/implementation'
  ...
  spec.add_development_dependency 'data_error_int', '~> 3'
